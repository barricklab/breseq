...
# One INS of AC at 10000, licensed by linkage: not two single-base insertions.
...
awk -F'\t' '
  BEGIN { want["10000"]; want["11702"]; want["12000"]; want["12005"]; want["12011"]; want["13020"]; want["15000"]; want["16000"]; want["17246"]; want["22375"] }
