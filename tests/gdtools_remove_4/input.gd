...
#=READSEQ	tests/lambda_mult_ref_read/../data/lambda/lambda_mixed_population.A.fastq
#=READSEQ	tests/lambda_mult_ref_read/../data/lambda/lambda_mixed_population.B.fastq
...
#=MAPPED-READS	51266
INV	.	.	NC_001416-0	450	2300	test=aa"sa
