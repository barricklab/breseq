...
CN	71	.	REL606	2041401	2041500	0	gene_name=wzx	gene_position=coding (1321-1420/1428 nt)	gene_product=O antigen translocase (Wzx)	gene_strand=<	locus_tag=ECB_01943	relative_coverage=0.234	tile_size=100
