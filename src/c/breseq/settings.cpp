...
namespace breseq
{
	...
	void Settings::init_installed()
	{
		...
		if (this->installed["smalt"].size() == 0) { this->installed["smalt"] = system("which smalt_i386 2>/dev/null") ? "smalt_i386" : ""; }
		if (this->installed["smalt"].size() == 0) { this->installed["smalt"] = system("which smalt_ia64 2>/dev/null") ? "smalt_ia64" : ""; }
		if (this->installed["smalt"].size() == 0) { this->installed["smalt"] = system("which smalt_x86_64 2>/dev/null") ? "smalt_x86_64" : ""; }
		if (this->installed["smalt"].size() == 0) { this->installed["smalt"] = system("which smalt_MacOSX_i386 2>/dev/null") ? "smalt_MacOSX_i386" : ""; }
