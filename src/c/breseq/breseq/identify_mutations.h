...
namespace breseq {
  ...
  static uint8_t kPolymorphismFrequencyPrecision = 4;
    ...
    polymorphism_prediction predict_polymorphism (uint8_t best_base, uint8_t second_best_base, std::vector<polymorphism_data>& pdata );

		//! Find best mixture of two bases and likelihood of producing observed read bases.
    std::pair<double,double> best_two_base_model_log10_likelihood(uint8_t best_base, uint8_t second_best_base, std::vector<polymorphism_data>& pdata); 

		//! Calculate likelihood of a specific mixture of two bases producing observed read bases.
    double calculate_two_base_model_log10_likelihood (uint8_t best_base, uint8_t second_best_base, std::vector<polymorphism_data>& pdata, double best_base_freq);
