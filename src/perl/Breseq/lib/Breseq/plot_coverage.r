...
lines(X$position, X$redundant_tot_cov, type="s", col="red", lty="solid", lwd=2 )
lines(X$position, X$redundant_top_cov, type="s", col="yellow", lty="solid")
lines(X$position, X$redundant_bot_cov, type="s", col="orange", lty="solid")
	
lines(X$position, X$unique_tot_cov, type="s", col="blue", lty="solid", lwd=2 )
lines(X$position, X$unique_top_cov, type="s", col="cyan", lty="solid")
lines(X$position, X$unique_bot_cov, type="s", col="purple", lty="solid")
